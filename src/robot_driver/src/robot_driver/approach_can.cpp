      ...
      current_distance_(std::numeric_limits<double>::infinity())
{
    ...
    range_subscription_ = node_->create_subscription<sensor_msgs::msg::Range>(
        "/ultrasonic_sensor/range", 10, std::bind(&ApproachCan::rangeCallback, this, std::placeholders::_1));
...
void ApproachCan::rangeCallback(const sensor_msgs::msg::Range::SharedPtr msg)
{
    current_distance_ = msg->range;
}
